...
// Heavily inspired by https://github.com/moderntribe/square-one/blob/main/wp-content/mu-plugins/force-plugin-activation.php

namespace Webikon;

class ForcePluginActivation
{
    /**
    ...
    private $force_active = [
        ...
        'better-image-sizes/better-image-sizes.php',
    ];
    ...
    {
        add_filter('option_active_plugins', [ $this, 'forcePlugins' ], 10, 1);
        add_filter('site_option_active_sitewide_plugins', [ $this, 'forcePlugins' ], 10, 1);
        add_filter('plugin_action_links', [ $this, 'pluginActionLinks' ], 99, 4);
        add_filter('network_admin_plugin_action_links', [ $this, 'pluginActionLinks' ], 99, 4);
        add_filter('all_plugins', [ $this, 'hideFromBlog' ], 99, 1);
    }
     ...
     * @return array|bool
     */
    public function forcePlugins($plugins)
    {
        /*
     ...
     * @return array mixed
     */
    public function hideFromBlog($plugins)
    {
        if (!is_multisite()) {
            return $plugins;
        }
